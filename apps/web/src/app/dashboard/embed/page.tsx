...
import { demoUser, demoEventTypes } from "@/lib/mock-data";
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
          ...
          <div className="card" style={{ padding: "24px" }}>
            ...
            >
              ...
              <a
                href={`/book/${demoUser.slug}/${demoEventTypes[0]?.slug || ""}`}
            ...
            {demoEventTypes
              ...
              .map((et) => (
                ...
                >
                  ...
                  >
                    bookly.app/book/{demoUser.slug}/{et.slug}
                  </code>
