...
export function BookingClient({ user, eventType, scheduleRules }: BookingClientProps) {
  ...
  }, [eventType.bookingWindowDays, scheduleRules]);
  ...
  }, [user.slug, eventType.slug, eventType.durationMinutes, scheduleRules]);
